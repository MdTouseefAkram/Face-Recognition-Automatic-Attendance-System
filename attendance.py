...
class Attendance:
    def __init__(self,root):
        ...
        #first image
        img = Image.open(r"C:\Users\mdtou\OneDrive\Desktop\Automatic Attendance System\Images\smart-attendance.jpg")
        ...
        #second image
        img1 = Image.open(r"C:\Users\mdtou\OneDrive\Desktop\Automatic Attendance System\Images\iStock-182059956_18390_t12.jpg")
        img1= img1.resize((700,200),Image.LANCZOS)
        self.photoimg1= ImageTk.PhotoImage(img1)

        f_lbl = Label(self.root, image = self.photoimg1)
        f_lbl.place(x=650,y=0,width=700, height=130)
        ...
        left_inside_frame.place(x=28,y=205,width=635,height=370)

        # Label and entry

        # Studenet id
        stud_Id_label = Label(left_inside_frame,text="Student ID:",font=("times new roman",12,"bold"),bg="white")
        stud_Id_label.grid(row=0, column=0,padx=5,pady=5,sticky=W)
                                
        stu_ID_entry=ttk.Entry(left_inside_frame,width=20,textvariable=self.var_atten_id,font=("times new roman",12,"bold"))
        stu_ID_entry.grid(row=0,column=1,padx=10,sticky=W)

        # Name
        studLabel = Label(left_inside_frame,text="Student Name:",bg="white",font="comicsansns 11 bold")
        studLabel.grid(row=0, column=2,padx=5,pady=5,sticky=W)
                                
        atten_stu_entry=ttk.Entry(left_inside_frame,width=20,textvariable=self.var_atten_name,font="comicsansns 11 bold")
        atten_stu_entry.grid(row=0,column=3,padx=10,sticky=W)
        ...
        self.dep=ttk.Combobox(left_inside_frame,width=18,textvariable=self.var_atten_dep,font="comicsansns 11 bold",state="readonly")
        self.dep["values"]=("Select Department","Civil Engineering","Computer Science & Engineering","Electronics & Communication Engineering","Electrical Engineering","Mechanical Engineering","BCA","Others")
        self.dep.grid(row=1,column=3,pady=5)
        self.dep.current(0)
        # Time
        ...
        attendanceTime_entry=ttk.Entry(left_inside_frame,width=20,textvariable=self.var_atten_time,font="comicsansns 11 bold")
        attendanceTime_entry.grid(row=2,column=1,padx=10,sticky=W)
        ...
        attendanceDate_entry=ttk.Entry(left_inside_frame,width=20,textvariable=self.var_atten_date,font="comicsansns 11 bold")
        attendanceDate_entry.grid(row=2,column=3,padx=10,sticky=W)
        ...
        btn_frame.place(x=0,y=265,width=630,height=40)
        ...
        Right_frame.place(x=650,y=0,width=720,height=570)

        table_frame=Frame(Right_frame,bd=2,relief=RIDGE,bg="white")
        table_frame.place(x=5,y=0,width=590,height=435)
